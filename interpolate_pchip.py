...
def main():
    ...
    df['Luas Panen'] = df['Luas Panen'].interpolate(method='pchip')
    df['Hasil Panen'] = df['Hasil Panen'].interpolate(method='pchip')
    df['Produktivitas'] = df['Produktivitas'].interpolate(method='pchip')
    df['Humidity'] = df['Humidity'].interpolate(method='pchip')
