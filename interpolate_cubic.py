...
def main():
    ...
    df['Luas Panen'] = df['Luas Panen'].interpolate(method='cubic')
    df['Hasil Panen'] = df['Hasil Panen'].interpolate(method='cubic')
    df['Produktivitas'] = df['Produktivitas'].interpolate(method='cubic')
    df['Humidity'] = df['Humidity'].interpolate(method='cubic')
