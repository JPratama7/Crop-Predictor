...
def main():
    ...
    df['Luas Panen'] = df['Luas Panen'].interpolate(method='piecewise_polynomial')
    df['Hasil Panen'] = df['Hasil Panen'].interpolate(method='piecewise_polynomial')
    df['Produktivitas'] = df['Produktivitas'].interpolate(method='piecewise_polynomial')
    df['Humidity'] = df['Humidity'].interpolate(method='piecewise_polynomial')
